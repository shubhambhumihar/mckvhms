      ...
      <div className="max-w-screen-2xl   border  w-[100%] mx-auto h-fit  ">
        ...
        <div className="my-6 w-[80%] mx-auto">
          ...
          <div className="shadow-lg p-7 shadow-white">
            <div className="grad h-[50vh]  flex justify-around py-7">
            ...
            <div className="flex shadow-lg shadow-purple-400 relative  justify-around py-14 p-10 mt-[-20vh] w-[80%] mx-auto rounded-3xl bg-[#FE6244] ">
              ...
              <div className="flex justify-center ">
                ...
                <div className="p-6  flex   flex-col ">
                  ...
                  <h2 className="text-white font-semibold pb-4">
                    Contact No. - {student?.student?.contactNumber}{" "}
                  </h2>
                  <h2 className="text-white font-semibold pb-4">
                    Parents Contact No. -{" "}
