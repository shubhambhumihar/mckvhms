    ...
    <div className="max-w-screen-2xl my-6" id="maintain">
      <div className="mx-auto grid lg:grid-cols-2 justify-center place-items-center  gap-2">
        <div className="p-7 border-r-[1px] h-[50%] border-gray-400">
          ...
          <p className="text-[12px] md:text-sm font-light p-7 text-gray-200 py-4">
          ...
          <h4 className="text-2xl text-center md:text-3xl mb-5 text-[#654E92] border-b-2 border-purple-600 max-w-[200px] mx-auto">
            Our staffs
          </h4>
