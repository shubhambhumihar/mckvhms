...
const PostShare = () => {
  ...
  // }, []);
  return (
    <div className="flex gap-3 bg-[#2C3333] p-4 rounded-sm  border  ">
      <img className="rounded-full w-12 h-12 " src={imgg} alt="" />
      <div className="flex w-[90%] flex-col gap-4 p-2 rounded-sm  shadow-2xl shadow-gray-300">
        <input
          ref={desc}
          required
          className="rounded-xl p-2 border border-red-500 bg-[rgba(40,52,62,0.07)] outline-none"
          type="text"
